...
void VTestAccel::traceInitThis__1(VTestAccel__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->declBit(c+63,"clock",-1);
	vcdp->declBit(c+64,"reset",-1);
	vcdp->declBit(c+65,"sim_clock",-1);
	vcdp->declBit(c+66,"sim_wait",-1);
	vcdp->declBit(c+63,"TestAccel clock",-1);
	vcdp->declBit(c+64,"TestAccel reset",-1);
	vcdp->declBit(c+65,"TestAccel sim_clock",-1);
	vcdp->declBit(c+66,"TestAccel sim_wait",-1);
	vcdp->declBit(c+63,"TestAccel sim_shell_clock",-1);
	vcdp->declBit(c+64,"TestAccel sim_shell_reset",-1);
	vcdp->declBit(c+55,"TestAccel sim_shell_host_req_valid",-1);
	vcdp->declBit(c+56,"TestAccel sim_shell_host_req_opcode",-1);
	vcdp->declBus(c+57,"TestAccel sim_shell_host_req_addr",-1,7,0);
	vcdp->declBus(c+58,"TestAccel sim_shell_host_req_value",-1,31,0);
	...
	vcdp->declBit(c+59,"TestAccel sim_shell_mem_rd_valid",-1);
	vcdp->declQuad(c+60,"TestAccel sim_shell_mem_rd_bits",-1,63,0);
	vcdp->declBit(c+65,"TestAccel sim_shell_sim_clock",-1);
	vcdp->declBit(c+62,"TestAccel sim_shell_sim_wait",-1);
	vcdp->declBit(c+63,"TestAccel vta_accel_clock",-1);
	vcdp->declBit(c+64,"TestAccel vta_accel_reset",-1);
	vcdp->declBit(c+55,"TestAccel vta_accel_io_host_req_valid",-1);
	vcdp->declBit(c+56,"TestAccel vta_accel_io_host_req_opcode",-1);
	vcdp->declBus(c+57,"TestAccel vta_accel_io_host_req_addr",-1,7,0);
	vcdp->declBus(c+58,"TestAccel vta_accel_io_host_req_value",-1,31,0);
	...
	vcdp->declBit(c+59,"TestAccel vta_accel_io_mem_rd_valid",-1);
	vcdp->declQuad(c+60,"TestAccel vta_accel_io_mem_rd_bits",-1,63,0);
	vcdp->declBit(c+63,"TestAccel sim_shell clock",-1);
	vcdp->declBit(c+64,"TestAccel sim_shell reset",-1);
	vcdp->declBit(c+55,"TestAccel sim_shell host_req_valid",-1);
	vcdp->declBit(c+56,"TestAccel sim_shell host_req_opcode",-1);
	vcdp->declBus(c+57,"TestAccel sim_shell host_req_addr",-1,7,0);
	vcdp->declBus(c+58,"TestAccel sim_shell host_req_value",-1,31,0);
	...
	vcdp->declBit(c+59,"TestAccel sim_shell mem_rd_valid",-1);
	vcdp->declQuad(c+60,"TestAccel sim_shell mem_rd_bits",-1,63,0);
	vcdp->declBit(c+65,"TestAccel sim_shell sim_clock",-1);
	vcdp->declBit(c+62,"TestAccel sim_shell sim_wait",-1);
	vcdp->declBit(c+62,"TestAccel sim_shell mod_sim_dpi_wait",-1);
	vcdp->declBit(c+64,"TestAccel sim_shell mod_sim_reset",-1);
	vcdp->declBit(c+65,"TestAccel sim_shell mod_sim_clock",-1);
	vcdp->declBit(c+55,"TestAccel sim_shell mod_host_dpi_req_valid",-1);
	vcdp->declBit(c+56,"TestAccel sim_shell mod_host_dpi_req_opcode",-1);
	vcdp->declBus(c+57,"TestAccel sim_shell mod_host_dpi_req_addr",-1,7,0);
	vcdp->declBus(c+58,"TestAccel sim_shell mod_host_dpi_req_value",-1,31,0);
	...
	vcdp->declBit(c+64,"TestAccel sim_shell mod_host_reset",-1);
	vcdp->declBit(c+63,"TestAccel sim_shell mod_host_clock",-1);
	...
	vcdp->declBus(c+67,"TestAccel sim_shell mod_mem_dpi_req_len",-1,7,0);
	...
	vcdp->declBit(c+59,"TestAccel sim_shell mod_mem_dpi_rd_valid",-1);
	vcdp->declQuad(c+60,"TestAccel sim_shell mod_mem_dpi_rd_bits",-1,63,0);
	vcdp->declBit(c+64,"TestAccel sim_shell mod_mem_reset",-1);
	vcdp->declBit(c+63,"TestAccel sim_shell mod_mem_clock",-1);
	vcdp->declBit(c+65,"TestAccel sim_shell mod_sim clock",-1);
	vcdp->declBit(c+64,"TestAccel sim_shell mod_sim reset",-1);
	vcdp->declBit(c+62,"TestAccel sim_shell mod_sim dpi_wait",-1);
	...
	vcdp->declBit(c+62,"TestAccel sim_shell mod_sim wait_reg",-1);
	vcdp->declBus(c+68,"TestAccel sim_shell mod_host ADDR_BITS",-1,31,0);
	vcdp->declBus(c+69,"TestAccel sim_shell mod_host DATA_BITS",-1,31,0);
	vcdp->declBit(c+63,"TestAccel sim_shell mod_host clock",-1);
	vcdp->declBit(c+64,"TestAccel sim_shell mod_host reset",-1);
	vcdp->declBit(c+55,"TestAccel sim_shell mod_host dpi_req_valid",-1);
	vcdp->declBit(c+56,"TestAccel sim_shell mod_host dpi_req_opcode",-1);
	vcdp->declBus(c+57,"TestAccel sim_shell mod_host dpi_req_addr",-1,7,0);
	vcdp->declBus(c+58,"TestAccel sim_shell mod_host dpi_req_value",-1,31,0);
	...
	vcdp->declBus(c+68,"TestAccel sim_shell mod_mem LEN_BITS",-1,31,0);
	vcdp->declBus(c+70,"TestAccel sim_shell mod_mem ADDR_BITS",-1,31,0);
	vcdp->declBus(c+70,"TestAccel sim_shell mod_mem DATA_BITS",-1,31,0);
	vcdp->declBit(c+63,"TestAccel sim_shell mod_mem clock",-1);
	vcdp->declBit(c+64,"TestAccel sim_shell mod_mem reset",-1);
	...
	vcdp->declBus(c+67,"TestAccel sim_shell mod_mem dpi_req_len",-1,7,0);
	...
	vcdp->declBit(c+59,"TestAccel sim_shell mod_mem dpi_rd_valid",-1);
	vcdp->declQuad(c+60,"TestAccel sim_shell mod_mem dpi_rd_bits",-1,63,0);
	...
	vcdp->declBit(c+63,"TestAccel vta_accel clock",-1);
	vcdp->declBit(c+64,"TestAccel vta_accel reset",-1);
	vcdp->declBit(c+55,"TestAccel vta_accel io_host_req_valid",-1);
	vcdp->declBit(c+56,"TestAccel vta_accel io_host_req_opcode",-1);
	vcdp->declBus(c+57,"TestAccel vta_accel io_host_req_addr",-1,7,0);
	vcdp->declBus(c+58,"TestAccel vta_accel io_host_req_value",-1,31,0);
	...
	vcdp->declBit(c+59,"TestAccel vta_accel io_mem_rd_valid",-1);
	vcdp->declQuad(c+60,"TestAccel vta_accel io_mem_rd_bits",-1,63,0);
	vcdp->declBit(c+63,"TestAccel vta_accel rf_clock",-1);
	vcdp->declBit(c+64,"TestAccel vta_accel rf_reset",-1);
	...
	vcdp->declBit(c+55,"TestAccel vta_accel rf_io_host_req_valid",-1);
	vcdp->declBit(c+56,"TestAccel vta_accel rf_io_host_req_opcode",-1);
	vcdp->declBus(c+57,"TestAccel vta_accel rf_io_host_req_addr",-1,7,0);
	vcdp->declBus(c+58,"TestAccel vta_accel rf_io_host_req_value",-1,31,0);
	...
	vcdp->declBit(c+63,"TestAccel vta_accel ce_clock",-1);
	vcdp->declBit(c+64,"TestAccel vta_accel ce_reset",-1);
	...
	vcdp->declBit(c+59,"TestAccel vta_accel ce_io_mem_rd_valid",-1);
	vcdp->declQuad(c+60,"TestAccel vta_accel ce_io_mem_rd_bits",-1,63,0);
	vcdp->declBit(c+63,"TestAccel vta_accel rf clock",-1);
	vcdp->declBit(c+64,"TestAccel vta_accel rf reset",-1);
	...
	vcdp->declBit(c+55,"TestAccel vta_accel rf io_host_req_valid",-1);
	vcdp->declBit(c+56,"TestAccel vta_accel rf io_host_req_opcode",-1);
	vcdp->declBus(c+57,"TestAccel vta_accel rf io_host_req_addr",-1,7,0);
	vcdp->declBus(c+58,"TestAccel vta_accel rf io_host_req_value",-1,31,0);
	...
	vcdp->declBus(c+71,"TestAccel vta_accel rf initvar",-1,31,0);
	vcdp->declBit(c+63,"TestAccel vta_accel ce clock",-1);
	vcdp->declBit(c+64,"TestAccel vta_accel ce reset",-1);
	...
	vcdp->declBit(c+59,"TestAccel vta_accel ce io_mem_rd_valid",-1);
	vcdp->declQuad(c+60,"TestAccel vta_accel ce io_mem_rd_bits",-1,63,0);
	vcdp->declBit(c+63,"TestAccel vta_accel ce sliceAccum_clock",-1);
	vcdp->declBit(c+64,"TestAccel vta_accel ce sliceAccum_reset",-1);
	...
	vcdp->declQuad(c+35,"TestAccel vta_accel ce sliceAccum_io_in",-1,62,0);
	vcdp->declQuad(c+37,"TestAccel vta_accel ce sliceAccum_io_sum",-1,63,0);
	vcdp->declBit(c+63,"TestAccel vta_accel ce overallAccum_clock",-1);
	vcdp->declBit(c+64,"TestAccel vta_accel ce overallAccum_reset",-1);
	vcdp->declBit(c+39,"TestAccel vta_accel ce overallAccum_io_rst",-1);
	vcdp->declBit(c+40,"TestAccel vta_accel ce overallAccum_io_valid",-1);
	vcdp->declQuad(c+41,"TestAccel vta_accel ce overallAccum_io_in",-1,62,0);
	vcdp->declQuad(c+9,"TestAccel vta_accel ce overallAccum_io_sum",-1,63,0);
	vcdp->declBus(c+43,"TestAccel vta_accel ce state",-1,2,0);
	// Tracing: TestAccel vta_accel ce _RAND_0 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:636
	vcdp->declBus(c+15,"TestAccel vta_accel ce cycles",-1,31,0);
	// Tracing: TestAccel vta_accel ce _RAND_1 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:638
	vcdp->declQuad(c+44,"TestAccel vta_accel ce reg1",-1,63,0);
	// Tracing: TestAccel vta_accel ce _RAND_2 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:640
	vcdp->declQuad(c+46,"TestAccel vta_accel ce reg2",-1,63,0);
	// Tracing: TestAccel vta_accel ce _RAND_3 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:642
	vcdp->declBus(c+48,"TestAccel vta_accel ce cnt",-1,31,0);
	// Tracing: TestAccel vta_accel ce _RAND_4 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:644
	vcdp->declQuad(c+49,"TestAccel vta_accel ce raddr1",-1,63,0);
	// Tracing: TestAccel vta_accel ce _RAND_5 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:646
	vcdp->declQuad(c+51,"TestAccel vta_accel ce raddr2",-1,63,0);
	// Tracing: TestAccel vta_accel ce _RAND_6 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:648
	vcdp->declQuad(c+53,"TestAccel vta_accel ce waddr",-1,63,0);
	// Tracing: TestAccel vta_accel ce _RAND_7 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:650
	// Tracing: TestAccel vta_accel ce _T_88 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:651
	// Tracing: TestAccel vta_accel ce _GEN_0 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:652
	// Tracing: TestAccel vta_accel ce _T_89 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:653
	// Tracing: TestAccel vta_accel ce _T_90 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:654
	// Tracing: TestAccel vta_accel ce _GEN_1 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:655
	// Tracing: TestAccel vta_accel ce _T_91 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:656
	// Tracing: TestAccel vta_accel ce _T_92 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:657
	// Tracing: TestAccel vta_accel ce _GEN_2 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:658
	// Tracing: TestAccel vta_accel ce _T_93 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:659
	// Tracing: TestAccel vta_accel ce _T_94 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:660
	// Tracing: TestAccel vta_accel ce _T_96 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:661
	// Tracing: TestAccel vta_accel ce _T_97 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:662
	// Tracing: TestAccel vta_accel ce _T_98 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:663
	// Tracing: TestAccel vta_accel ce _T_99 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:664
	// Tracing: TestAccel vta_accel ce _GEN_3 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:665
	// Tracing: TestAccel vta_accel ce _GEN_4 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:666
	// Tracing: TestAccel vta_accel ce _GEN_5 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:667
	// Tracing: TestAccel vta_accel ce _GEN_6 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:668
	// Tracing: TestAccel vta_accel ce _GEN_7 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:669
	// Tracing: TestAccel vta_accel ce _GEN_8 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:670
	// Tracing: TestAccel vta_accel ce _GEN_9 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:671
	// Tracing: TestAccel vta_accel ce _GEN_10 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:672
	// Tracing: TestAccel vta_accel ce _T_100 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:673
	// Tracing: TestAccel vta_accel ce _T_106 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:674
	// Tracing: TestAccel vta_accel ce _T_109 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:675
	// Tracing: TestAccel vta_accel ce _T_110 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:676
	// Tracing: TestAccel vta_accel ce _GEN_11 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:677
	// Tracing: TestAccel vta_accel ce _T_114 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:678
	// Tracing: TestAccel vta_accel ce _T_115 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:679
	// Tracing: TestAccel vta_accel ce _T_117 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:680
	// Tracing: TestAccel vta_accel ce _T_118 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:681
	// Tracing: TestAccel vta_accel ce _GEN_12 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:682
	// Tracing: TestAccel vta_accel ce _GEN_13 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:683
	// Tracing: TestAccel vta_accel ce _T_119 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:684
	// Tracing: TestAccel vta_accel ce _T_120 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:685
	// Tracing: TestAccel vta_accel ce _T_121 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:686
	// Tracing: TestAccel vta_accel ce _T_122 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:687
	// Tracing: TestAccel vta_accel ce _T_130 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:688
	// Tracing: TestAccel vta_accel ce _T_132 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:689
	// Tracing: TestAccel vta_accel ce _T_133 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:690
	// Tracing: TestAccel vta_accel ce _T_134 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:691
	// Tracing: TestAccel vta_accel ce _T_138 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:692
	// Tracing: TestAccel vta_accel ce _T_139 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:693
	// Tracing: TestAccel vta_accel ce _T_140 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:694
	// Tracing: TestAccel vta_accel ce _T_150 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:695
	// Tracing: TestAccel vta_accel ce _T_151 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:696
	// Tracing: TestAccel vta_accel ce _GEN_21 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:697
	// Tracing: TestAccel vta_accel ce _T_152 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:698
	// Tracing: TestAccel vta_accel ce _T_158 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:699
	// Tracing: TestAccel vta_accel ce _T_159 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:700
	// Tracing: TestAccel vta_accel ce _GEN_19 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:701
	vcdp->declBit(c+13,"TestAccel vta_accel ce ready",-1);
	// Tracing: TestAccel vta_accel ce _RAND_8 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:703
	vcdp->declBus(c+72,"TestAccel vta_accel ce initvar",-1,31,0);
	vcdp->declBit(c+63,"TestAccel vta_accel ce sliceAccum clock",-1);
	vcdp->declBit(c+64,"TestAccel vta_accel ce sliceAccum reset",-1);
	...
	vcdp->declQuad(c+35,"TestAccel vta_accel ce sliceAccum io_in",-1,62,0);
	vcdp->declQuad(c+37,"TestAccel vta_accel ce sliceAccum io_sum",-1,63,0);
	vcdp->declQuad(c+37,"TestAccel vta_accel ce sliceAccum reg$",-1,63,0);
	// Tracing: TestAccel vta_accel ce sliceAccum _RAND_0 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:535
	// Tracing: TestAccel vta_accel ce sliceAccum _GEN_2 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:536
	// Tracing: TestAccel vta_accel ce sliceAccum _T_18 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:537
	// Tracing: TestAccel vta_accel ce sliceAccum _T_22 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:538
	// Tracing: TestAccel vta_accel ce sliceAccum _GEN_0 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:539
	// Tracing: TestAccel vta_accel ce sliceAccum _GEN_1 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:540
	// Tracing: TestAccel vta_accel ce sliceAccum _GEN_4 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:541
	// Tracing: TestAccel vta_accel ce sliceAccum _GEN_5 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:542
	vcdp->declBus(c+73,"TestAccel vta_accel ce sliceAccum initvar",-1,31,0);
	vcdp->declBit(c+63,"TestAccel vta_accel ce overallAccum clock",-1);
	vcdp->declBit(c+64,"TestAccel vta_accel ce overallAccum reset",-1);
	vcdp->declBit(c+39,"TestAccel vta_accel ce overallAccum io_rst",-1);
	vcdp->declBit(c+40,"TestAccel vta_accel ce overallAccum io_valid",-1);
	vcdp->declQuad(c+41,"TestAccel vta_accel ce overallAccum io_in",-1,62,0);
	...
	// Tracing: TestAccel vta_accel ce overallAccum _RAND_0 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:535
	// Tracing: TestAccel vta_accel ce overallAccum _GEN_2 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:536
	// Tracing: TestAccel vta_accel ce overallAccum _T_18 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:537
	// Tracing: TestAccel vta_accel ce overallAccum _T_22 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:538
	// Tracing: TestAccel vta_accel ce overallAccum _GEN_0 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:539
	// Tracing: TestAccel vta_accel ce overallAccum _GEN_1 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:540
	// Tracing: TestAccel vta_accel ce overallAccum _GEN_4 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:541
	// Tracing: TestAccel vta_accel ce overallAccum _GEN_5 // Ignored: Inlined leading underscore at /Users/benjamintu/Desktop/research/tvm/vta/apps/tsim_example/hardware/chisel/build/chisel/TestAccel.v:542
	vcdp->declBus(c+74,"TestAccel vta_accel ce overallAccum initvar",-1,31,0);
    }
}
...
void VTestAccel::traceFullThis__1(VTestAccel__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->fullQuad(c+35,((VL_ULL(0x7fffffffffffffff) 
			      & (((QData)((IData)(__Vtemp76[1U])) 
				  << 0x20U) | (QData)((IData)(
							      __Vtemp76[0U]))))),63);
	vcdp->fullQuad(c+37,(vlTOPp->TestAccel__DOT__vta_accel__DOT__ce__DOT__sliceAccum__DOT__reg__024),64);
	vcdp->fullBit(c+39,((1U & vlTOPp->TestAccel__DOT__vta_accel__DOT__rf__DOT__reg_4)));
	vcdp->fullBit(c+40,(vlTOPp->TestAccel__DOT__vta_accel__DOT__ce__DOT__overallAccum_io_valid));
	...
	vcdp->fullQuad(c+41,((VL_ULL(0x7fffffffffffffff) 
			      & (((QData)((IData)(__Vtemp79[1U])) 
				  << 0x20U) | (QData)((IData)(
							      __Vtemp79[0U]))))),63);
	vcdp->fullBus(c+43,(vlTOPp->TestAccel__DOT__vta_accel__DOT__ce__DOT__state),3);
	vcdp->fullQuad(c+44,(vlTOPp->TestAccel__DOT__vta_accel__DOT__ce__DOT__reg1),64);
	vcdp->fullQuad(c+46,(vlTOPp->TestAccel__DOT__vta_accel__DOT__ce__DOT__reg2),64);
	vcdp->fullBus(c+48,(vlTOPp->TestAccel__DOT__vta_accel__DOT__ce__DOT__cnt),32);
	vcdp->fullQuad(c+49,(vlTOPp->TestAccel__DOT__vta_accel__DOT__ce__DOT__raddr1),64);
	vcdp->fullQuad(c+51,(vlTOPp->TestAccel__DOT__vta_accel__DOT__ce__DOT__raddr2),64);
	vcdp->fullQuad(c+53,(vlTOPp->TestAccel__DOT__vta_accel__DOT__ce__DOT__waddr),64);
	vcdp->fullBit(c+55,(vlTOPp->TestAccel__DOT__sim_shell__DOT__mod_host_dpi_req_valid));
	vcdp->fullBit(c+56,(vlTOPp->TestAccel__DOT__sim_shell__DOT__mod_host_dpi_req_opcode));
	vcdp->fullBus(c+57,(vlTOPp->TestAccel__DOT__sim_shell__DOT__mod_host_dpi_req_addr),8);
	vcdp->fullBus(c+58,(vlTOPp->TestAccel__DOT__sim_shell__DOT__mod_host_dpi_req_value),32);
	vcdp->fullBit(c+59,(vlTOPp->TestAccel__DOT__sim_shell__DOT__mod_mem_dpi_rd_valid));
	vcdp->fullQuad(c+60,(vlTOPp->TestAccel__DOT__sim_shell__DOT__mod_mem_dpi_rd_bits),64);
	vcdp->fullBit(c+62,(vlTOPp->TestAccel__DOT__sim_shell__DOT__mod_sim__DOT__wait_reg));
	vcdp->fullBit(c+63,(vlTOPp->clock));
	vcdp->fullBit(c+64,(vlTOPp->reset));
	vcdp->fullBit(c+65,(vlTOPp->sim_clock));
	vcdp->fullBit(c+66,(vlTOPp->sim_wait));
	vcdp->fullBus(c+67,(0U),8);
	vcdp->fullBus(c+68,(8U),32);
	vcdp->fullBus(c+69,(0x20U),32);
	vcdp->fullBus(c+70,(0x40U),32);
	vcdp->fullBus(c+71,(vlTOPp->TestAccel__DOT__vta_accel__DOT__rf__DOT__initvar),32);
	vcdp->fullBus(c+72,(vlTOPp->TestAccel__DOT__vta_accel__DOT__ce__DOT__initvar),32);
	vcdp->fullBus(c+73,(vlTOPp->TestAccel__DOT__vta_accel__DOT__ce__DOT__sliceAccum__DOT__initvar),32);
	vcdp->fullBus(c+74,(vlTOPp->TestAccel__DOT__vta_accel__DOT__ce__DOT__overallAccum__DOT__initvar),32);
    }
}
